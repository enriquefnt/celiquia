    ...
    <form onkeydown="return event.key != 'Enter';" class="row g-3" action="" method="post" id='formulario' autocomplete="off">
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          <span class="input-group-text">
            <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Seleccione el establecimiento donde tiene asignada la mayor parte de las horas el nuevo usuario"></i>
          </span>
        </div>
      </div>
      <div>
      ...
      <div class="col-sm-3">
        ...
        <div class="input-group">
          ...
          <span class="input-group-text">
            <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="indique el celular como codigo de área sin 0 - número sin 15, en caso de que el código de área tenga 4 dígitos, agreguelo al cuarto al número"></i>
          </span>
        </div>
      ...
      <div class="col-sm-3">
        ...
        <div class="input-group">
          ...
          <span class="input-group-text">
            <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Anote el correo electronico particular, puede ser también el institucional si está personalizado.
      ...
      if (empty($datosUser['user'])) { ?>
        ...
        <div class="col-sm-3">
          ...
          <div class="input-group">
            ...
            <span class="input-group-text">
              <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Elija un nombre de usuario que sea facil de recordar, 
      ...
      si coloca uno  que ya esta en la base, se advertirá que lo cambie"></i>
        ...
        <div class="col-sm-3">
          ...
          <div class="input-group">
            ...
            <span class="input-group-text">
              <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Puede tener números, letras y caracteres especiales, se sugiere que tenga al menos 6 caracteres"></i>
            </span>
          </div>
        </div>
